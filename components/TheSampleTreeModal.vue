<template>
  ...
  <AppWindowModal
    ...
    :legend="
      about?.progeniesCount ? `${about.progeniesCount + 1} Items` : 'Item'
    "
  ...
  >
    <div class="container">
          ...
          >
            <table>
              <tr v-for="item in items" :key="item.thText">
                ...
                <td>
                  <p class="text" :class="{ monospace: key === 'ID' }">
                    {{ item.tdText }}
                  </p>
                </td>
                <td v-if="key === 'ID'">
      ...
      <div v-if="about.link && about.link.length === 16" class="buttons">
        <AppButton class="button" @end.self="onClickJump"> Jump </AppButton>
      </div>
      <div class="buttons">
  ...
  >
    <div class="container">
      ...
      <AppInputKey v-if="!isSupportTouch" @enter="buttonEvent.press(1)" />
      <div class="buttons">
