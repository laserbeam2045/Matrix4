...
(function() {
    ...
    Event.prototype.stop = function() {
        // イベントキャンセル
        this.preventDefault();		// 加工：これがスクロールを止める効力がある
        // イベント伝達を止める
...
//            this.element.addEventListener("touchstart", function(e) { e.stop(); });		// 加工：touchstartからendに変更
            //this.element.addEventListener("touchmove", function(e) { e.stop(); });	// 加工：スクロールを可能にする
