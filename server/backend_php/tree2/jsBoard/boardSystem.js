...
function putStone( app, z, user, test ) {		// 着手する関数
	...
	switch (prisoners) {
		case 0: var sound = app.MainScene.stone_sound_1; break;
		case 1: var sound = app.MainScene.capture_sound_1; break;
		case 2: var sound = app.MainScene.capture_sound_2; break;
		case 3: var sound = app.MainScene.capture_sound_3; break;
		default: var sound = app.MainScene.capture_sound_many;
	}
