...
.buttons {
  ...
  $box-shadow: $color3 2px 2px 10px, $color3 -2px -2px 10px,
    $color3 40px 0px 50px -50px inset, $color3 -40px 0px 50px -50px inset,
    $color4 0px -40px 50px -50px inset, $color4 0px 40px 50px -50px inset;
